"""Flet Demo - English Dictation Practice App (Flet 0.21.2)"""
import flet as ft
import random

SAMPLE_WORDS = [
    {"word": "apple", "meaning": "apple", "phonetic": "/ˈæpl/", "example": "I eat an apple every day.", "status": "pending", "error_count": 0},
    {"word": "banana", "meaning": "banana", "phonetic": "/bəˈnɑːnə/", "example": "The banana is yellow.", "status": "pending", "error_count": 0},
...
def main(page: ft.Page):
    ...
    answer = ft.TextField(hint_text="Type...", text_align=ft.TextAlign.CENTER, text_size=18)
    ...
    passage_loading = ft.Container(
        content=ft.Column([ft.ProgressRing(), ft.Text("Generating...", size=13, color=ft.colors.GREY_600)],
    ...
    page.navigation_bar = ft.NavigationBar(
        ...
        destinations=[
            ...
            ft.NavigationDestination(icon=ft.icons.EDIT, label="Dictation"),
            ft.NavigationDestination(icon=ft.icons.ARTICLE, label="Reading"),
            ft.NavigationDestination(icon=ft.icons.ANALYTICS, label="Stats"),
