...
from common.services.llm import extract_words_from_text, generate_hint_for_word, test_connection, batch_generate_meanings, generate_meaning_for_word, generate_passage
from common.llm.passage_generator import PassageGenerator
from common.llm.providers import PROVIDER_PRESETS
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler(os.path.join(project_root, 'instance', 'app.log'), encoding='utf-8')
    ]
)
...
def auto_generate_meanings_on_startup():
    """启动时自动为没有释义的单词生成释义"""
    from storage.database import get_words_without_meanings
